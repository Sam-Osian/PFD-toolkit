...
THEME_COLLECTION_SVG_MAP: dict[str, str] = {
    "access_to_care": '<svg viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="18" cy="36" r="6"></circle><circle cx="36" cy="20" r="6"></circle><circle cx="54" cy="36" r="6"></circle><path d="M24 33L30 24"></path><path d="M42 24L48 33"></path><path d="M24 39L48 39"></path></svg>',
    "ambulance_response": '<svg viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="12" y="24" width="48" height="24" rx="6"></rect><path d="M20 36H30"></path><path d="M25 31V41"></path><path d="M42 36H52"></path><circle cx="24" cy="52" r="3"></circle><circle cx="48" cy="52" r="3"></circle></svg>',
    "care_home": '<svg viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M14 33L36 16L58 33"></path><path d="M20 31V57H52V31"></path><rect x="30" y="41" width="12" height="16" rx="2"></rect><path d="M25 45H20"></path><path d="M52 45H47"></path></svg>',
    "discharge_planning": '<svg viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="16" y="14" width="30" height="44" rx="4"></rect><path d="M24 26H38"></path><path d="M24 34H38"></path><path d="M24 42H34"></path><path d="M46 36H56"></path><path d="M52 30L58 36L52 42"></path></svg>',
    "environmental_safety": '<svg viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M36 14L58 54H14L36 14Z"></path><path d="M36 30V41"></path><circle cx="36" cy="48" r="1.8"></circle></svg>',
    "equipment_safety": '<svg viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="14" y="20" width="26" height="32" rx="4"></rect><rect x="44" y="26" width="14" height="20" rx="3"></rect><path d="M23 36L29 42L36 31"></path></svg>',
    "falls_prevention": '<svg viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M20 54H54"></path><path d="M24 48L34 30L44 40L54 24"></path><circle cx="24" cy="48" r="3"></circle><circle cx="34" cy="30" r="3"></circle><circle cx="44" cy="40" r="3"></circle><circle cx="54" cy="24" r="3"></circle></svg>',
    "family_involvement": '<svg viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="24" cy="26" r="6"></circle><circle cx="48" cy="26" r="6"></circle><path d="M16 46C16 40 20 36 24 36C28 36 32 40 32 46"></path><path d="M40 46C40 40 44 36 48 36C52 36 56 40 56 46"></path><path d="M32 46H40"></path></svg>',
    "hospital_care": '<svg viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="16" y="14" width="40" height="44" rx="6"></rect><path d="M36 24V40"></path><path d="M28 32H44"></path><rect x="24" y="44" width="24" height="10" rx="2"></rect></svg>',
    "infection_control": '<svg viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M36 12C36 12 22 24 22 36C22 45 28 52 36 52C44 52 50 45 50 36C50 24 36 12 36 12Z"></path><path d="M30 37L34 41L42 32"></path></svg>',
    "interagency_communication": '<svg viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="10" y="16" width="22" height="18" rx="4"></rect><rect x="40" y="16" width="22" height="18" rx="4"></rect><rect x="25" y="38" width="22" height="18" rx="4"></rect><path d="M32 25H40"></path><path d="M22 34L31 41"></path><path d="M50 34L41 41"></path></svg>',
    "medication_safety": '<svg viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="14" y="25" width="44" height="22" rx="11"></rect><path d="M36 25V47"></path><path d="M24 36H31"></path><path d="M41 36H48"></path></svg>',
    "mental_health_care": '<svg viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M36 56C50 48 56 39 56 29C56 20 49 14 41 14C36 14 33 16 30 20C27 16 24 14 19 14C11 14 4 20 4 29C4 39 10 48 24 56L30 59L36 56Z"></path><path d="M24 35H31L35 29L39 37L43 33H50"></path></svg>',
    "observation_failures": '<svg viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="36" cy="36" r="18"></circle><circle cx="36" cy="36" r="6"></circle><path d="M36 18V24"></path><path d="M36 48V54"></path><path d="M18 36H24"></path><path d="M48 36H54"></path></svg>',
    "online_hazards": '<svg viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="12" y="14" width="48" height="34" rx="5"></rect><path d="M28 56H44"></path><path d="M36 48V56"></path><path d="M31 30L36 24L41 30"></path><path d="M36 24V38"></path></svg>',
    "physical_health_in_mental_health": '<svg viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M20 56V40C20 30 27 24 36 24C45 24 52 30 52 40V56"></path><circle cx="36" cy="16" r="6"></circle><path d="M30 42H42"></path><path d="M36 36V48"></path></svg>',
    "record_keeping": '<svg viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M22 12H43L54 23V60H22V12Z"></path><path d="M43 12V23H54"></path><path d="M28 33H46"></path><path d="M28 41H46"></path><path d="M28 49H40"></path></svg>',
    "road_safety": '<svg viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M27 12L18 60"></path><path d="M45 12L54 60"></path><path d="M36 16V24"></path><path d="M36 30V38"></path><path d="M36 44V52"></path></svg>',
    ...
    "staff_shortages": '<svg viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="23" cy="24" r="5"></circle><circle cx="36" cy="24" r="5"></circle><circle cx="49" cy="24" r="5"></circle><path d="M16 46C16 39 20 34 23 34C26 34 30 39 30 46"></path><path d="M29 46C29 39 33 34 36 34C39 34 43 39 43 46"></path><path d="M42 46C42 39 46 34 49 34C52 34 56 39 56 46"></path></svg>',
    "staff_training": '<svg viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M10 26L36 14L62 26L36 38L10 26Z"></path><path d="M18 30V42C18 47 27 52 36 52C45 52 54 47 54 42V30"></path><path d="M62 26V40"></path></svg>',
    "substance_misuse": '<svg viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="16" y="20" width="14" height="32" rx="4"></rect><path d="M20 20V14H26V20"></path><rect x="38" y="26" width="18" height="26" rx="4"></rect><path d="M38 36H56"></path></svg>',
    "suicide": '<svg viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M36 14C24 14 14 24 14 36C14 48 24 58 36 58C48 58 58 48 58 36C58 24 48 14 36 14Z"></path><path d="M24 48L48 24"></path><path d="M24 24H48V48"></path></svg>',
...
THEME_SEMANTIC_ICON_RULES: tuple[tuple[tuple[str, ...], str], ...] = (
    ...
    (("follow_up", "waiting_times", "missed_appointments", "continuity"), "clock"),
