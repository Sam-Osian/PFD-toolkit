...
class GeneralConfig:
    ...
    LEGACY_AREA_SYNONYMS: Dict[str, str] = {
        ...
        "Greater Manchester North": "Manchester North",
        "Greater Manchester South": "Manchester South",
        "Greater Manchester West": "Manchester West",
        "Kent Central and South East": "Kent and Medway",
        "Kent Mid and Medway": "Kent and Medway",
        "Kent North East": "Kent and Medway",
